...
plot(error/desvest)
```
 Una medida del error total de la aproximación es el "Root Mean Squared Error" o RMSE, y se calcula como la raíz cuadrada del cuadrado del error. Las unidades de RMSE son las mismas que analizamos, de modo que nos indicará por cuántos metros en promedio falló la aproximación:
