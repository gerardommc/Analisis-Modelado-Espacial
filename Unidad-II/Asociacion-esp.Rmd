...
I.meds <- moran(x = datos$Mediciones, listw = vec.listw, n = 1, S0 = S0)

I.res <- moran(x = datos$Residuales, listw = vec.listw, n = 1, S0 = S0)
I.meds$I
I.res$I
```

Lo que sugiere que los residuales tienden a la dispersión aleatoria. El valor obtenido de I para los residuales cambia la conclusión a la que habíamos llegado por medio del análisis visual de los residuales. Sin embargo, !los residuales están más agregados que los datos crudos! El índice de Moran no es una prueba perfecta, más aún con datos de puntos para los cuales el concepto de "vecino" es más ambiguo que con rásters y polígonos. 
